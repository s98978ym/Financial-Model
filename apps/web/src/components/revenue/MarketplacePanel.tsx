  ...
  return (
    <div className="space-y-5">
              ...
              <div className="space-y-2 text-[11px]">
                <div className="flex items-center justify-between">
                  ...
                  <input type="text" value={s.name}
                    ...
                    className="w-24 text-right bg-transparent font-medium text-gray-900 outline-none focus:bg-white focus:rounded px-1" />
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-500">平均取引額</span>
                  <span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-gray-500">取引回数/人</span>
      ...
      <div className="flex items-center gap-3 text-[11px] px-1">
        <span className="text-gray-500 font-medium">手数料率 (テイクレート):</span>
          ...
          <table className="w-full text-[11px]">
            <thead>
              <tr className="border-b border-cyan-200">
                <th className="text-left px-3 py-2 text-gray-500 font-medium">サイド</th>
            ...
            <tbody>
              ...
              <tr className="border-t border-cyan-200 bg-cyan-100/30">
                <td className="px-3 py-2 text-gray-500">GMV</td>
                {fyGMV.map(function(gmv, fi) {
                  return <td key={fi} className="px-3 py-2 text-right font-mono text-gray-600">{formatYen(gmv)}円</td>
                })}
              </tr>
              <tr className="border-t-2 border-cyan-200 bg-cyan-100/50">
                <td className="px-3 py-2 font-semibold text-gray-700">売上 ({(config.take_rate * 100).toFixed(0)}%)</td>
